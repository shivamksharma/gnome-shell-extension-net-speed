/**
 * Net Speed GNOME Shell Extension - Preferences
 * 
 * GTK-based settings UI for configuring the network speed indicator.
 * Compatible with GNOME Shell 42 (uses GTK4 + libadwaita)
 */
...
/**
 * Fill the preferences window with settings widgets
 * 
 * @param {Adw.PreferencesWindow} window - The preferences window to populate
 */
function fillPreferencesWindow(window) {
    const settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.netspeed');
